            ...
            <div class="d-flex ml-auto flex-column flex-lg-row align-items-center">
              <ul class="navbar-nav  ">
                <li class="nav-item active">
                  <a class="nav-link" href="user_panel.php">Panel <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link"  href="#" onclick="deleteAllCookies(); redirect('login.php');"> (<?php echo $_COOKIE['username']?>) Logout </a>
                </li>
              </ul>
  ...
  <?php } else {?>
    ...
    <script>
        ...
        function redirectWithMessage() {
            ...
            document.querySelector('p').innerHTML = 'Redirecting to the login page...';

            // Set a delay (in milliseconds) before redirecting
